...
const GameMenu: React.FC<PropTypes> = () => {
    ...
    const timeControls = [
        ...
        // Тестовый сверхбыстрый режим: 90 s + 1 s/ход.
        // НЕ делаем меньше 60 s: серверная legacy-эвристика (точное значение
        // timeControl < 60 трактует как legacy-МИНУТЫ) умножила бы 30 на 60,
        // превратив «30-секундный» тест в полную 30-минутную партию.
        { tc: 1.5, tp: 1, label: "90s+1s", test: true },
    ];
